...
namespace ApiClient
{
    ...
    public static class GraphQlTypes
    {
        ...
        public const string PetMutation = "PetMutation";
        public const string PetQuery = "PetQuery";

        public const string AddPetInput = "AddPetInput";
        public const string DeletePetInput = "DeletePetInput";
        public const string UpdatePetInput = "UpdatePetInput";
        ...
        public static readonly IReadOnlyDictionary<Type, string> ReverseMapping =
            new Dictionary<Type, string>
            {
                ...
                { typeof(AddPetInput), "AddPetInput" },
                { typeof(DeletePetInput), "DeletePetInput" },
                { typeof(UpdatePetInput), "UpdatePetInput" }
            };
}
    #endregion
    ...
    public partial class PetQueryQueryBuilder : GraphQlQueryBuilder<PetQueryQueryBuilder>
    {
        private static readonly GraphQlFieldMetadata[] AllFieldMetadata =
            new []
            {
                new GraphQlFieldMetadata { Name = "pets", IsComplex = true, QueryBuilderType = typeof(PetQueryBuilder) }
            };

        protected override string TypeName { get { return "PetQuery"; } } 

        public override IReadOnlyList<GraphQlFieldMetadata> AllFields { get { return AllFieldMetadata; } } 

        public PetQueryQueryBuilder(string operationName = null) : base("query", operationName)
        {
        }

        public PetQueryQueryBuilder WithParameter<T>(GraphQlQueryParameter<T> parameter)
        {
            return WithParameterInternal(parameter);
        }

        public PetQueryQueryBuilder WithPets(PetQueryBuilder petQueryBuilder, string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            return WithObjectField("pets", alias, petQueryBuilder, new GraphQlDirective[] { skip, include });
        }

        public PetQueryQueryBuilder ExceptPets()
        {
            return ExceptField("pets");
        }
    }

    public partial class PetMutationQueryBuilder : GraphQlQueryBuilder<PetMutationQueryBuilder>
    {
        private static readonly GraphQlFieldMetadata[] AllFieldMetadata =
            new []
            {
                new GraphQlFieldMetadata { Name = "addPet", IsComplex = true, QueryBuilderType = typeof(PetQueryBuilder) },
                new GraphQlFieldMetadata { Name = "deletePet" },
                new GraphQlFieldMetadata { Name = "updatePet" }
            };

        protected override string TypeName { get { return "PetMutation"; } } 

        public override IReadOnlyList<GraphQlFieldMetadata> AllFields { get { return AllFieldMetadata; } } 

        public PetMutationQueryBuilder(string operationName = null) : base("mutation", operationName)
        {
        }

        public PetMutationQueryBuilder WithParameter<T>(GraphQlQueryParameter<T> parameter)
        {
            return WithParameterInternal(parameter);
        }

        public PetMutationQueryBuilder WithAddPet(PetQueryBuilder petQueryBuilder, QueryBuilderParameter<AddPetInput> input, string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            var args = new List<QueryBuilderArgumentInfo>();
            args.Add(new QueryBuilderArgumentInfo { ArgumentName = "input", ArgumentValue = input} );
            return WithObjectField("addPet", alias, petQueryBuilder, new GraphQlDirective[] { skip, include }, args);
        }

        public PetMutationQueryBuilder ExceptAddPet()
        {
            return ExceptField("addPet");
        }

        public PetMutationQueryBuilder WithDeletePet(QueryBuilderParameter<DeletePetInput> input, string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            var args = new List<QueryBuilderArgumentInfo>();
            args.Add(new QueryBuilderArgumentInfo { ArgumentName = "input", ArgumentValue = input} );
            return WithScalarField("deletePet", alias, new GraphQlDirective[] { skip, include }, args);
        }

        public PetMutationQueryBuilder ExceptDeletePet()
        {
            return ExceptField("deletePet");
        }

        public PetMutationQueryBuilder WithUpdatePet(QueryBuilderParameter<UpdatePetInput> input, string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            var args = new List<QueryBuilderArgumentInfo>();
            args.Add(new QueryBuilderArgumentInfo { ArgumentName = "input", ArgumentValue = input} );
            return WithScalarField("updatePet", alias, new GraphQlDirective[] { skip, include }, args);
        }

        public PetMutationQueryBuilder ExceptUpdatePet()
        {
            return ExceptField("updatePet");
        }
    }

    public partial class PetQueryBuilder : GraphQlQueryBuilder<PetQueryBuilder>
    {
        private static readonly GraphQlFieldMetadata[] AllFieldMetadata =
            new []
            {
        ...
        protected override string TypeName { get { return "Pet"; } } 

        public override IReadOnlyList<GraphQlFieldMetadata> AllFields { get { return AllFieldMetadata; } } 

        public PetQueryBuilder WithId(string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            return WithScalarField("id", alias, new GraphQlDirective[] { skip, include });
        }

        public PetQueryBuilder ExceptId()
        {
            return ExceptField("id");
        }

        public PetQueryBuilder WithName(string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            return WithScalarField("name", alias, new GraphQlDirective[] { skip, include });
        }

        public PetQueryBuilder ExceptName()
        {
            return ExceptField("name");
        }

        public PetQueryBuilder WithAge(string alias = null, SkipDirective skip = null, IncludeDirective include = null)
        {
            return WithScalarField("age", alias, new GraphQlDirective[] { skip, include });
        }

        public PetQueryBuilder ExceptAge()
        {
    ...
    public partial class AddPetInput : IGraphQlInputObject
    {
        private InputPropertyInfo _name;
        private InputPropertyInfo _age;
        ...
        #endif
        public QueryBuilderParameter<int?> Age
        {
            get { return (QueryBuilderParameter<int?>)_age.Value; }
            set { _age = new InputPropertyInfo { Name = "age", Value = value }; }
        }

        IEnumerable<InputPropertyInfo> IGraphQlInputObject.GetPropertyValues()
        {
            if (_name.Name != null) yield return _name;
            if (_age.Name != null) yield return _age;
        }
    }

    public partial class DeletePetInput : IGraphQlInputObject
    {
    ...
    public partial class UpdatePetInput : IGraphQlInputObject
    {
        private InputPropertyInfo _id;
        private InputPropertyInfo _name;
        private InputPropertyInfo _age;
    ...
    #region data classes
    public partial class PetQuery
    {
        public ICollection<Pet> Pets { get; set; }
    }

    public partial class PetMutation
    {
        public Pet AddPet { get; set; }
        public int? DeletePet { get; set; }
        public int? UpdatePet { get; set; }
    }
